...
const translations = {
    ...
    'director.message_html': {
        fr: `Lancé en 2021 sous l'impulsion des autorités étatiques, le programme <strong>XAM-XAM</strong> est né d'une volonté claire : offrir aux jeunes un cadre structuré de formation orienté vers l'excellence, la discipline et l'insertion professionnelle durable.<br><br>
...
XAM-XAM n'est pas qu'un dispositif de formation ; c'est un engagement durable en faveur de la jeunesse, de la compétence et de la transformation positive par le savoir appliqué.`,
        en: `Launched in 2021 under the impetus of government authorities, the <strong>XAM-XAM</strong> program was born from a clear vision: to provide young people with a structured training framework focused on excellence, discipline and lasting professional integration.<br><br>
